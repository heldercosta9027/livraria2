...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Jan-2021 às 15:49
...
CREATE TABLE `livros` (
  ...
  `ficheiro_sinopse` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `livros` (`id_livro`, `titulo`, `idioma`, `total_paginas`, `data_edicao`, `isbn`, `observacoes`, `imagem_capa`, `id_genero`, `id_autor`, `sinopse`, `created_at`, `updated_at`, `deleted_at`, `id_user`, `ficheiro_sinopse`) VALUES
...
(3, 'qwwqeqe', 'Portugês', 1312, NULL, '9789728830304', NULL, '1610027866_Koala.jpg', 1, 3, NULL, NULL, '2021-01-07 13:57:46', NULL, NULL, ''),
...
(16, 'qwwqeqe', 'qwewqeqe', 1312, NULL, '1234567891011', NULL, '1610029218_Koala.jpg', 1, NULL, NULL, '2021-01-07 13:47:42', '2021-01-07 14:20:18', NULL, 1, '');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tipo_user` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal' COMMENT 'normal ou admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Helder', 'hdmc367@gmail.com', NULL, '$2y$10$GVjDO0R4RP5EfIwIVljUPOiVQOVk/QRG34aSvE.SpE/NyE7HeFbQe', NULL, '2020-12-10 13:55:07', '2020-12-10 13:55:07', 'admin');
